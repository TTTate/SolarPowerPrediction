...
def remove_redundant_features(data: pd.DataFrame, threshold: float = 0.95, target_feature: str = 'pv_measurement') -> pd.DataFrame: #TO-DO: Review this function
    """
    ...
    # Find all pairs of features with high correlation
    redundant_pairs = []
